    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">add New service</h5>
        ...
        <div class="modal-body">
          ...
          <form class="needs-validation row">
            ...
            {{-- image --}}
            <div class="mb-3">
              <label for="service-image" class="form-label">service logo</label>
              <input class="form-control" type="file" id="service-image">
            </div>
