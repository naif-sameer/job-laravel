              ...
              <tr>
                ...
                <td>
                  <div style="width: 100px">
                    <img class="img-thumbnail img-fluid" src="{{ asset('assets/images/' . $slider->image) }}"
                      alt="table image">
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex gap-2">
                    <button
                      @click="id = {{ $slider->id }}; title = '{{ $slider->title }}'; description = '{{ $slider->description }}'; image = '{{ $slider->image }}'"
                      class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editModal">Edit</button>

                    <button @click="id = {{ $slider->id }}" class="btn btn-danger" data-bs-toggle="modal"
          ...
          <div class="modal-body">
            ...
            <form method="POST" class="needs-validation row" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input name="image" class="form-control" type="file" id="slider-image">
              </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form class="modal-footer" method="POST" x-bind:action="'/admin/sliders/' + id">
            @csrf
            @method('DELETE')
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            {{-- form --}}
            <form class="needs-validation row" method="POST" :action="'/admin/sliders/' + id"
              ...
              <div class="mb-3">
                <label for="slider-image" class="form-label">Slider image</label>
                <input name="image" x-bind:value="image" class="form-control" type="file" id="slider-image">
              </div>
