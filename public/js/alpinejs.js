(() => {
  ...
  function Ze(e) {
    ...
    for (let o of r)
      if (!t.includes(o) && (Lt.forEach((s) => s(o)), o._x_cleanups))
...
`
  ...
  function st(e, t) {
    ...
    re(r, e);
    let n = [r, ...k(e)];
    if (typeof t == "function") return ln(n, t);
    let i = un(n, t, e);
  ...
  function ve(e, t, r, n, i) {
    if (typeof t == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => ve(e, s, r, n)).catch((s) => J(s, i, t))
        : e(o);
    } else e(t);
  }
  var ct = "x-";
  ...
  function or() {
    ...
    Array.from(document.querySelectorAll(ir()))
      .filter(e)
      .forEach((t) => {
        w(t);
      }),
  ...
  function V(e, t = !1) {
    return Q(e, (r) => {
      if ((t ? ir() : ar()).some((i) => r.matches(i))) return !0;
    });
  }
  function Q(e, t) {
    if (!!e) {
  ...
  d(
    ...
    (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
      typeof n == "function" && (n = i(n)), n ? bn(e, n, t) : vn(e, r, t);
    }
  );
  function bn(e, t, r) {
    ur(e, oe, ""),
  ...
  function fr(e) {
    let t = e.parentNode;
    if (!!t) return t._x_hidePromise ? t : fr(t);
  }
  function Re(
    e,
    t,
  ...
  function An(e, t) {
    if (e.type === "radio")
      ...
      Number.isInteger(t)
        ...
        : (e.checked = !!t);
    else if (e.tagName === "SELECT") Mn(e, t);
    else {
      if (e.value === t) return;
      e.value = t;
    }
  ...
  var q = {},
    gr = !1;
  function xr(e, t) {
    if ((gr || ((q = A(q)), (gr = !0)), t === void 0)) return q[e];
    (q[e] = t),
      typeof t == "object" &&
        t !== null &&
  ...
  function Mr(e) {
    e.active &&
      (Rr(e), e.options.onStop && e.options.onStop(), (e.active = !1));
  }
  var zn = 0;
  function Bn(e, t) {
    let r = function () {
      ...
      if (!fe.includes(r)) {
        Rr(r);
        try {
          return Vn(), fe.push(r), (R = r), e();
        } finally {
          fe.pop(), Nr(), (R = fe[fe.length - 1]);
        }
      }
    };
    return (
  ...
  function O(e, t, r) {
    ...
    i || n.set(r, (i = new Set())),
      i.has(R) ||
        ...
        R.deps.push(i),
        R.options.onTrack &&
          R.options.onTrack({ effect: R, target: e, type: t, key: r }));
  }
    ...
    if (t === "clear") s.forEach(c);
      ...
      switch ((r !== void 0 && c(s.get(r)), t)) {
        case "add":
          $(e)
            ? Ie(r) && c(s.get("length"))
            : (c(s.get(U)), X(e) && c(s.get(vt)));
          break;
        case "delete":
          $(e) || (c(s.get(U)), X(e) && c(s.get(vt)));
          break;
        case "set":
          X(e) && c(s.get(U));
          break;
  ...
  ["includes", "indexOf", "lastIndexOf"].forEach((e) => {
    ...
    $e[e] = function (...r) {
      let n = _(this);
      for (let o = 0, s = this.length; o < s; o++) O(n, "get", o + "");
      let i = t.apply(n, r);
  ...
  function De(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      return (ke(i) ? kr.has(i) : qn(i)) || (e || O(n, "get", i), t)
        ? a
        : Et(a)
        ? !s || !Ie(i)
          ? a.value
  ...
  function $r(e = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!e && ((i = _(i)), (s = _(s)), !$(r) && Et(s) && !Et(i)))
        return (s.value = i), !0;
      let a = $(r) && Ie(n) ? Number(n) < r.length : le(r, n),
        c = Reflect.set(r, n, i, o);
      return (
        r === _(o) &&
          (a ? yt(i, s) && L(r, "set", n, i, s) : L(r, "add", n, i)),
        c
      );
    };
  }
  ...
  function ti(e, t) {
    ...
    return (!ke(t) || !kr.has(t)) && O(e, "has", t), r;
  }
  function ri(e) {
    return O(e, "iterate", $(e) ? "length" : U), Reflect.ownKeys(e);
  }
  var Lr = { get: Un, set: Qn, deleteProperty: ei, has: ti, ownKeys: ri },
    jr = {
      get: Gn,
      set(e, t) {
        return (
  ...
  function Be(e, t = !1) {
    return (
      (e = e.__v_raw), !t && O(_(e), "iterate", U), Reflect.get(e, "size", e)
    );
  }
  function Fr(e) {
    e = _(e);
  ...
  function ze(e, t) {
    return function (n, i) {
      let o = this,
        ...
        c = t ? Ot : e ? At : St;
      return (
        !e && O(a, "iterate", U), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Ve(e, t, r) {
    return function (...n) {
      let i = this.__v_raw,
        ...
        u = r ? Ot : t ? At : St;
      return (
        !t && O(o, "iterate", c ? vt : U),
        {
          next() {
            let { value: p, done: x } = l.next();
            return x
              ? { value: p, done: x }
              : { value: a ? [u(p[0]), u(p[1])] : u(p), done: x };
          },
          [Symbol.iterator]() {
            return this;
          },
    ...
    return function (...t) {
      {
        ...
        console.warn(
          `${xt(e)} operation ${r}failed: target is readonly.`,
          _(this)
        );
      }
  ...
  y(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = I(ci(e))), e._x_refs_proxy)
  );
  function ci(e) {
    let t = [],
      r = e;
  ...
  d(
    ...
    (
      ...
      if (!t) return gi(e, n, i, o);
      if (t === "key") return xi(e, n);
      let s = g(e, n);
      o(() =>
        s((a) => {
      ...
      for (let f = 0; f < u.length; f++) {
        ...
        if (b === -1) c.splice(f, 0, h), p.push([pe, f]);
          ...
          let v = c.splice(f, 1)[0],
            S = c.splice(b - 1, 1)[0];
          c.splice(f, 0, S), c.splice(b, 0, v), x.push([v, S]);
        } else W.push(h);
        pe = h;
      }
  ...
  P.setEvaluator(st);
  P.setReactivityEngine({ reactive: Le, effect: Cr, release: Mr, raw: _ });
  var Nt = P;
  window.Alpine = Nt;
  queueMicrotask(() => {
    Nt.start();
