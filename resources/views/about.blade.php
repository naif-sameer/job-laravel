            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 mt-4">
                        ...
                        <article class="card">
                            <div
                                class="card-title p-3 d-flex flex-column gap-5 justify-content-center align-items-center m-0">
                                <h3 class="mb-0">
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <article class="card p-3">
                                    <div
                                        class="card-title d-flex flex-column gap-3 justify-content-center align-items-center m-0">
                                        <h3 class="mb-0">
                                            <a class="text-primary fs-5" href="#">Monthly Salary Range</a>
                                        </h3>
                                        <p class="text-black-50 mb-0">$1,000-4,000</p>
