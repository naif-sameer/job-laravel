...
@section('content')
  <main class="h-full overflow-y-auto">
    <div class="container mx-auto grid px-6">
      ...
      <!-- CTA -->
      <a class="focus:shadow-outline-purple mb-8 flex items-center justify-between rounded-lg bg-purple-600 p-4 text-sm font-semibold text-purple-100 shadow-md focus:outline-none"
          ...
          <span class="col-span-4 mt-2 flex sm:mt-auto sm:justify-end">
            <nav aria-label="Table navigation">
              <ul class="inline-flex items-center">
                <li>
                  <button class="focus:shadow-outline-purple rounded-md rounded-l-lg px-3 py-1 focus:outline-none"
                    aria-label="Previous">
                ...
                <li>
                  <button class="focus:shadow-outline-purple rounded-md px-3 py-1 focus:outline-none">
                    1
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button
                    class="focus:shadow-outline-purple rounded-md border border-r-0 border-purple-600 bg-purple-600 px-3 py-1 text-white transition-colors duration-150 focus:outline-none">
                    3
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button class="focus:shadow-outline-purple rounded-md rounded-r-lg px-3 py-1 focus:outline-none"
                    aria-label="Next">
