      ...
      <div class="carousel-inner px-3">
        ...
        <div class="carousel-item active" data-bs-interval="5000">
          <div class="row">
            ...
            <div class="d-flex justify-content-center col-12 col-lg-5 col-md-5 col-sm-5 order-sm-2 order-1">
              <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_5zh17nif.json" background="transparent"
        ...
        <div class="carousel-item" data-bs-interval="5000">
          <div class="row">
            ...
            <div class="d-flex justify-content-center col-12 col-lg-5 col-md-5 col-sm-5 order-sm-2 order-1">
              <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_muiaursk.json" background="transparent"
                speed="1" style="width: 300px; height: 300px" loop autoplay>
              </lottie-player>
            </div>
          </div>
