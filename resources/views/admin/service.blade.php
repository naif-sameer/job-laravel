...
@section('content')
  <div x-data="{ id: null, title: '', description: '' }">
              ...
              <tr>
                ...
                <td>
                  <div style="width: 100px">
                    <img class="img-thumbnail img-fluid" src="{{ asset('assets/images/' . $service->image) }}"
                      alt="image">
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex gap-2">
                    <button
                      @click=" id = {{ $service->id }}; title = '{{ $service->title }}'; description = '{{ $service->description }}'"
                      class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editModal">Edit</button>

                    <button @click="id = {{ $service->id }}" class="btn btn-danger" data-bs-toggle="modal"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="POST" class="needs-validation row" enctype="multipart/form-data">
              ...
              {{-- title --}}
              <div class="mb-3">
                <label for="title-input-id" class="form-label">Name</label>
              ...
              <div class="mb-3">
                ...
                <input name="image" class="form-control" type="file" id="service-image">
              </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form class="modal-footer" method="POST" x-bind:action="'/admin/services/' + id">
            @csrf
            @method('DELETE')
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            {{-- form --}}
            <form class="needs-validation row" method="POST" :action="'/admin/services/' + id"
              ...
              {{-- title --}}
              <div class="mb-3">
                <label for="title-edit-input" class="form-label">Name</label>
                <input name="title" type="text" x-bind:value="title" class="form-control" id="title-edit-input"
                  placeholder="">
              </div>
              ...
              <div class="mb-3">
                <label for="service-image" class="form-label">image</label>
                <input name="image" x-bind:value="image" class="form-control" type="file" id="service-image">
              </div>
